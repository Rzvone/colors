    ...
    <div>
      ...
      <div>
        {user?.purchases?.length || 0 > 0 ? (
                  ...
                  {typeof purchase === 'string' ? (
                    ...
                    <Link href={`/products/${purchase.slug}`} className={classes.item}>
                      ...
                      <div className={classes.itemDetails}>
                        ...
                        >{`Serviciu finalizat la: ${formatDateTime(purchase.createdAt)}`}</p>
                      </div>
                    </Link>
                  )}
                </li>
          ...
          <div className={classes.noPurchases}>Inca nu ati beneficiat de nici un serviciu.</div>
        )}
      </div>
    </div>
  )
